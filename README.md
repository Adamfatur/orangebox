# 🍊 OrangeBox v1.3 — Sistem Sortir Sampah Cerdas dengan 7-Servo Locking System
...
- ✨ **Bin Capacity Monitoring** - Real-time monitoring dengan sensor ultrasonic + Blynk IoT
- ✨ **Auto-Prevent Overflow** - System blocks sorting jika bin sudah penuh (≥85%)
...
- ✅ Install semua Python packages (OpenCV, NumPy, Blynk, dll)
...
- **Sensor Ultrasonic**: **2x HC-SR04** untuk monitoring kapasitas tong
  - **Sensor 1** (BIN A): GPIO 23 (TRIG), GPIO 24 (ECHO)
  - **Sensor 2** (BIN B): GPIO 5 (TRIG), GPIO 6 (ECHO)
  - **⚠️ PENTING:** Gunakan voltage divider 5V→3.3V pada pin ECHO!
  - 📋 **[Bin Monitoring Guide](docs/BIN_MONITORING_GUIDE.md)** - Setup & troubleshooting
